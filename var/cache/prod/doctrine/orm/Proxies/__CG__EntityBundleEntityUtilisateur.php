 ...
 */
class Utilisateur extends \EntityBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Utilisateur' . "\0" . 'idFacebook');
        }
