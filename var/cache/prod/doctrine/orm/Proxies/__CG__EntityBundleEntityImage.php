 ...
 */
class Image extends \EntityBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Image' . "\0" . 'urlImg');
        }
