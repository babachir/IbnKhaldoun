...
class Commentaire extends \EntityBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Commentaire' . "\0" . 'utilisateur', '' . "\0" . 'EntityBundle\\Entity\\Commentaire' . "\0" . 'article', '' . "\0" . 'EntityBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Commentaire' . "\0" . 'contenu', '' . "\0" . 'EntityBundle\\Entity\\Commentaire' . "\0" . 'isvalid');
        }
     ...
     * {@inheritDoc}
     */
    public function setArticle(\EntityBundle\Entity\Article $article)
    {
     ...
     * {@inheritDoc}
     */
    public function setUtilisateur(\EntityBundle\Entity\Utilisateur $utilisateur)
    {
    ...
    public function setIsvalide($isvalide)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsvalide', array($isvalide));

        return parent::setIsvalide($isvalide);
    }
    ...
    public function getIsvalide()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsvalide', array());

        return parent::getIsvalide();
    }
